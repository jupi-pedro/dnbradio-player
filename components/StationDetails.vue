          ...
          <v-card-actions p0 fluid>
            <v-row justify="space-around" class="user-button-group">
              <v-btn icon @click="loadPrev(false)">
                <v-icon medium dark :size="windowHeight > windowWidth ? 32: 24">mdi-skip-previous</v-icon>
              </v-btn>
              ...
              <v-btn icon @click="loadNext(false)">
                <v-icon medium dark :size="windowHeight > windowWidth ? 32: 24">mdi-skip-next</v-icon>
              </v-btn>
            </v-row>
          </v-card-actions>
